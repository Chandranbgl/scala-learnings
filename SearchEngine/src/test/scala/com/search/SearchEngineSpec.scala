...
class SearchEngineSpec extends FunSuite {
  ...
  test ("top 10 files matching on search1") {
    ...
    assert(s"${res(0)._2}: ${res(0)._1}%" === "file1.txt: 100%")
    assert(s"${res(1)._2}: ${res(1)._1}%" === "file13.txt: 100%")
    assert(s"${res(2)._2}: ${res(2)._1}%" === "file14.txt: 100%")
    assert(s"${res(3)._2}: ${res(3)._1}%" === "file15.txt: 100%")
    assert(s"${res(4)._2}: ${res(4)._1}%" === "file16.txt: 100%")
    assert(s"${res(5)._2}: ${res(5)._1}%" === "file2.txt: 100%")
    assert(s"${res(6)._2}: ${res(6)._1}%" === "file3.txt: 100%")
    assert(s"${res(7)._2}: ${res(7)._1}%" === "file4.txt: 100%")
  ...
  test ("top 10 files matching on search2") {
    ...
    assert(s"${res(0)._2}: ${res(0)._1}%" === "file1.txt: 83%")
    assert(s"${res(1)._2}: ${res(1)._1}%" === "file13.txt: 83%")
    assert(s"${res(2)._2}: ${res(2)._1}%" === "file14.txt: 83%")
    assert(s"${res(3)._2}: ${res(3)._1}%" === "file15.txt: 83%")
    assert(s"${res(4)._2}: ${res(4)._1}%" === "file16.txt: 83%")
    assert(s"${res(5)._2}: ${res(5)._1}%" === "file2.txt: 83%")
    assert(s"${res(6)._2}: ${res(6)._1}%" === "file3.txt: 83%")
    assert(s"${res(7)._2}: ${res(7)._1}%" === "file4.txt: 83%")
    assert(s"${res(8)._2}: ${res(8)._1}%" === "file5.txt: 83%")
    assert(s"${res(9)._2}: ${res(9)._1}%" === "file6.txt: 83%")
  }
  ...
  test ("top 1 file matching on search") {
    val fileContents = FileLoader.getFileContents("src/test/resources/files")
